  ...
  <div class="login-box-body">
    ...
    <!-- <form action="" method="post"> -->
      <div class="form-group has-feedback">
        <input id="inUser" type="text" class="form-control" placeholder="Username" name="username">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input id="inPass" type="password" class="form-control" placeholder="Password" name="password">
